...
- 新增**極速秒翻**，按下翻譯後 1 秒就看到頁面開始變中文（限 Gemini）
...
- **三翻譯引擎**：Gemini（AI 翻譯、品質最佳、需 API Key）+ Google Translate（非官方免費端點、不需 API Key、速度更快）+ **自訂模型**（v1.5.7 起，OpenAI 相容端點，可接 OpenRouter / Together / DeepSeek / Groq / Ollama 本機等百種模型），依場景自由切換
...
v1.8.10 — 完整功能清單與規格詳見 [SPEC.md](SPEC.md)。
